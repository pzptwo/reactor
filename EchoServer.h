...
class EchoServer
{
    ...
    public:
        ...
        //接口！！！！
        void HandleNewConnection(Connection *conn);   //处理新连接上来的,Socket *clientsock这里不行，类之间的关系而且这样直接跳过来outbuffer
        ...
        void onworkmessage(Connection* conn,std::string & message); //  这里是建立workthread的工作任务
